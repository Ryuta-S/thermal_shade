...
def main():
    ...
    load_path_1 = os.path.join('..','data', '0006_0915','sun_vals_0001.npy')
    load_path_2 = os.path.join('..','data', '0006_0915','non_sun_vals_0001.npy')

    #output_path = '../data/0006_0915/plot_0001.png'
    output_path = os.path.join('..','data', '0006_0915','plot_0001.png')
    ...
    plt.plot(range(len(non_sun_vals)), non_sun_vals, label='shade')
    plt.legend()
